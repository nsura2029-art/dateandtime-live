...
<head>
  ...
  <link rel="stylesheet" href="/src/tz-hub.css?v=26" />
  <style>
  ...
  <header class="site-header">
    <div class="container header-row">
      ...
      <nav class="nav-main" aria-label="Main">
        ...
        <div class="nav-item has-dropdown" data-nav-item>
          <a href="/world-time/" class="nav-link nav-dropdown-label">
            <span class="nav-icon" aria-hidden="true">🕐</span>World time
          </a>
          <button class="nav-dropdown-toggle" aria-haspopup="true" aria-expanded="false" aria-label="Toggle World time menu">
        ...
        <div class="nav-item has-dropdown" data-nav-item>
          <a href="/time-zones/" class="nav-link nav-dropdown-label">
            <span class="nav-icon" aria-hidden="true">🌐</span>Timezone
          </a>
          <button class="nav-dropdown-toggle" aria-haspopup="true" aria-expanded="false" aria-label="Toggle Timezone menu">
            <svg class="dropdown-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
          </button>
          <div class="nav-dropdown" role="menu">
            <a href="/time-zones/" class="dropdown-item" role="menuitem">
              ...
              <span class="dropdown-desc">Browse all 356 IANA time zones</span>
            </a>
  ...
  <footer class="site-footer" role="contentinfo">
    <div class="site-footer-inner">
      ...
      <p class="site-footer-meta">
        ...
        33,945 cities · 356 time zones · 1,600+ holidays ·
