        ...
        <div class="city-clock-block">
          ...
          <div class="city-clock-row">
            ...
            <div class="city-time-block">
              <!-- 2-digit hours (06:26:11 instead of 6:26:11) -->
...
${moreToExplore.map(x => `        <a href="/world-time/united-states/${x.slug}/" class="explore-link">
  ...
  (function() {
    ...
    function update() {
      try {
        var now = new Date();
        // 2-digit hours: '06:26:11 PM' instead of '6:26:11 PM'
        var fmt = new Intl.DateTimeFormat('en-US', { timeZone: tz, hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: true });
